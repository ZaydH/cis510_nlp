...
\begin{frame}{20 Newsgroups Dataset -- What is it?}
  \begin{itemize}[<+->]
    \item Collection of internet message board posts divided into 20~disjoint labels
    % \begin{itemize}
    %   \item Positive Prior: ${\pDist(\y = \pcls) = 0.56}$
...
\onslide<+->{\textbf{Two Bias Types}:}
  ...
  \begin{itemize}[<+->]
    ...
    \item Discuss only ELMo results first \onslide<+->{since significantly better than LSTM}
  \end{itemize}
  \vfill
