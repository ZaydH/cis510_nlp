\begin{frame}{Basic Problem Setting}
  \onslide<+->{\blue{\textbf{Goal}}: Construct a text document binary classifier}
  \vfill
...
\begin{frame}{Key Terminology}
  ...
  \vfill
  \onslide<+->{%
    \textit{Example}: For a document-authorship classifier, it is usually impossible to collect a \textit{representative} sample of the negative class
    \begin{itemize}[<+->]
